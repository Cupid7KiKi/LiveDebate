...
export const REAL_SERVER_URL = 'http://1.15.95.154:8000';  // 真实后端服务器地址
...
// === 只改这一行即可一键切换全局API ===
export const LOCAL_BACKEND_URL = 'http://1.15.95.154:8000';  // Go后端服务器
export const API_BASE_URL = LOCAL_BACKEND_URL; // 连接Go后端服务器
